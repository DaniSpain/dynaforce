...
exports.init = function() {
    ...
    try {
        db.execute("CREATE TABLE IF NOT EXISTS Picklist(id INTEGER PRIMARY KEY AUTOINCREMENT, value TEXT, field TEXT, sobject TEXT, label TEXT,  UNIQUE(field, sobject) ON CONFLICT REPLACE);");
            ...
            callback: function(data) {
                try {
                    ...
                    for (var i = 0; fields.length > i; i++) {
                        ...
                        "reference" == f.type && Ti.API.info("[dynaforce] REFERENCE TO: " + f.referenceTo[0]);
                        fieldList[i] = f.name;
                        typeList[i] = f.type;
